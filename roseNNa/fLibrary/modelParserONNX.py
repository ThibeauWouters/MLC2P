...
parser.add_argument('--name',"-n", required=True, help="Please provide name of your pretrained model (must be goldenFiles dir name).")
parser.add_argument('--onnxfile',"-f", help="Please provide .onnx file of your pretrained model.")
...
# NEW -- just give name
file    = "../goldenFiles/" + name + "/" + name + ".onnx"
weigths = "../goldenFiles/" + name + "/" + name + "_weights.onnx"
